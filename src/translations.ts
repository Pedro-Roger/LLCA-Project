export const translations = {
  pt: {
    ...
    about: {
      ...
      p1: "O Instituto Científico Tecnológico LLCA surgiu em 2025 como resultado de uma trajetória iniciada por Altamiro Alvernaz para combater o Alzheimer de sua mãe.",
      p2: "O Centro atua como um hub de inovação e desenvolvimento da <strong>Engenharia Ecológica de Microbiomas</strong>, desenvolvida a partir da visão sistêmica de Altamiro Alvernaz, que também desenvolveu a <strong>metodologia de Equilíbrio do Ambiente Produtivo</strong> e o <strong>conceito de microbiomas projetados</strong>, base científica da <strong>Tecnologia de Consórcio Probiótico</strong> (TCP).",
    ...
    services: {
      ...
      items: [
        { title: "Agricultura", desc: "Soluções para uma agricultura mais sustentável e produtiva." },
        { title: "Saúde Humana", desc: "Desenvolvimento de probióticos e terapias baseadas em microbiomas." },
        { title: "Saneamento", desc: "Tecnologias para tratamento de resíduos e recuperação ambiental." },
        { title: "Energia", desc: "Pesquisa de fontes de energia renovável a partir de biomassa." }
      ]
    },
    contact: {
      tag: "Contato",
  ...
  en: {
    ...
    services: {
      ...
      title: "Our Services",
      items: [
        { title: "Agriculture", desc: "Solutions for more sustainable and productive agriculture." },
        { title: "Human Health", desc: "Development of probiotics and microbiome-based therapies." },
        { title: "Sanitation", desc: "Technologies for waste treatment and environmental recovery." },
        { title: "Energy", desc: "Research on renewable energy sources from biomass." }
      ]
    },
    contact: {
      tag: "Contact",
